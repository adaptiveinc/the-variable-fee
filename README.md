...
**Play it here: https://adaptiveinc.github.io/the-variable-fee/**

The game is a single self-contained HTML file, built from modular
source chunks. No install, no backend, works on phones.
